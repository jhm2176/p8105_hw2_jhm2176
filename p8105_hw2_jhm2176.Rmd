...
pols_month = read_csv("data/fivethirtyeight_datasets/pols-month.csv") %>%
  ...
  pivot_longer( #cant figure out how to pivot longer properly
...
snp = read_csv("data/fivethirtyeight_datasets/snp.csv") %>%
  ...
  mutate(month = month.name[as.numeric(month)], year = ifelse(as.numeric(year) > 22, as.numeric(year) +
                                                                1900, as.numeric(year) + 2000)) %>%
