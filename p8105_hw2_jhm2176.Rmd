...
print(pols)
```
**Note:** Original presidential data from August to December 1974 is coded as 2 instead of 0 or 1, likely due to Gerald Ford's temporary presidency in light of Nixon's resignation during this time. For this reason, I recoded values of 2 to "temp" and piped this into my `piivot_longer()` function.
